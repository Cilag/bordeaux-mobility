...
export const REGISTRY = [
  ...
  },
  {
    id: 'voies-noms',
    domaine: 'mobilite',
    libelle: 'Dénomination des voies',
    source: { type: 'opendatasoft', datasetId: 'fv_voie_a' },
    geometrie: null, // table d'attributs
    mode: ['voiture'],
    categorie: 'voirie',
    dateField: 'mdate',
  ...
  },
  {
    id: 'reve-itineraires',
    domaine: 'mobilite',
    libelle: 'Réseau Express Vélo (REVE) — itinéraires',
    source: { type: 'opendatasoft', datasetId: 'rh_itcyc_a' },
    geometrie: null, // table d'attributs
    mode: ['velo'],
    categorie: 'amenagement-cyclable',
    dateField: 'mdate',
    staticDate: '2019-04-03',
    millesime: null,
    viz: ['kpi-comptage'],
  },
  {
  ...
  },
  {
    id: 'lieux-desservis',
    domaine: 'mobilite',
    libelle: 'Lieux publics desservis par des arrêts',
    source: { type: 'opendatasoft', datasetId: 'sv_lipub_a' },
    geometrie: null, // table d'attributs
    mode: ['bus_tram'],
    categorie: 'reseau-bus',
    dateField: 'mdate',
  ...
  {
    id: 'arret-lieu-relations',
    domaine: 'mobilite',
    libelle: 'Relation arrêt — lieu public',
    source: { type: 'opendatasoft', datasetId: 'sv_arret_p_sv_lipub_a' },
    geometrie: null,
    mode: ['bus_tram'],
    categorie: 'reseau-bus',
    dateField: 'mdate',
  ...
  {
    id: 'zones-reglementaires',
    domaine: 'mobilite',
    libelle: 'Zones réglementaires de circulation (2020)',
    source: { type: 'opendatasoft', datasetId: 'bor_sigzonereg' },
    geometrie: 'polygone',
    mode: ['voiture'],
    categorie: 'zfe',
    dateField: 'mdate',
